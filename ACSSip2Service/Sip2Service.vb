...
#End Region
    ...
    Protected Overrides Sub OnStart(ByVal args() As String)
        Try
            ...
            ' ConnectionString = "SERVER=.;UID=sa;PWD=123;DATABASE=LibolTDM"
            DBServer = "SQLSERVER"
        ...
        Catch ex As Exception
            WriteSip2Log("EX1111:" & ex.Message)
        End Try
    End Sub
        ...
        If strChecksum.ToLower = "yes" Then
            ...
            If InStr(strControl, "AY") = 1 And InStr(strControl, "AZ") = 4 Then
                If Not VerifyChecksum(req) Then
                    ProcessRequest = "98YYYYYN3000052020030407001040292.00AO|AM|BXYYYYYYYYYYYYYYYY|AN|AF|AG|" ' "96AZ" & Checksum("96AZ")
                    Exit Function
                Else
