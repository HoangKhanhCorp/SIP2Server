...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.mmSip2 = New System.Windows.Forms.MainMenu(Me.components)
        ...
        Me.txtResult.Size = New System.Drawing.Size(704, 326)
        ...
        Me.sbSip2.Location = New System.Drawing.Point(0, 330)
        Me.sbSip2.Name = "sbSip2"
        Me.sbSip2.Size = New System.Drawing.Size(704, 24)
    ...
    Private Sub ChangeStatusSip2Server()
        ...
        If blnStartSip Then
            ...
            Else
                ...
                Application.DoEvents()
                MessageBox.Show("Has an error while to try stop service !", "ChinhNH - Sip2Server", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly)
            End If
        Else
            Try
                Dim k As Integer
            ...
            Else
                sbSip2.Text = "Sip2Server service is stopped"
                Application.DoEvents()
                MessageBox.Show("Has an error while to try start service !", "ChinhNH - Sip2Server", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly)
            End If
        End If
